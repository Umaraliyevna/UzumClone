        ...
        <ThemeProvider theme={theme}>
          <Stack direction={{ sm: "column", md: "row", lg: "row" }}>
            <ImagesInfoStyle>
              ...
              <Button className="showAllComment">
              ...
              <Box className="productDescription">
                ...
                <Typography>
                  ...
                  namlaydi, oziqlantiradi va ehtiyotkorlik bilan parvarish
                  qiladi. Nivea Creme tarkibida konservantlar mavjud emas va
                  shuning uchun hatto nozik chaqaloq terisiga ham mos keladi.
                </Typography>
                <img src={image} />
              </Box>
            </ImagesInfoStyle>
            <ProductCostCardStyle>
              <Box className="productCostCard">
                ...
                <Box className="stockInfo">
                  <Typography>
                    <FaCheck className="stockCheck" /> 46 dona xarid qilish
                    mumkin
                  </Typography>
                  <Typography>
                    <IoBagCheckOutline className="stockBag" /> Bu haftada 23
                    kishi sotib oldi
                  </Typography>
                </Box>
              </Box>
